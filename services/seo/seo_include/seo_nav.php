<nav aria-label="Main">
  <ul>
    ...
    <!-- About Us -->
    <li>
      <a href="/company-website/about_page/about_page.php">About us</a>
    </li>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a href="/company-website/services/seo/seo.php">SEO</a></li>
        <li><a href="/company-website/services/ppc/ppc.php">PPC</a></li>
    ...
    <!-- Blogs -->
    <li>
      <a href="/company-website/blog_page/blog.php">Blogs</a>
    </li>
