    ...
    <div class="container">
      <div class="aboutX-head">
        <div>
          ...
          <p class="leading">As a leading digital marketing company in Neb Sarai, Delhi, we don't believe in random tactics.
        ...
        <div class="aboutX-cta">
          <!-- <a class="btn btn-primary" href="#contact"><i class="fa-regular fa-calendar"></i> Book a Call</a> -->
        </div>
      </div>

      <div class="aboutX-grid">
        <!-- LEFT: Animated stats + bullets -->
        <div class="aboutX-panel reveal">
          <div class="aboutX-top">
            ...
            <div>
              ...
              <p>Whether you're a startup looking for scalable growth or an 
                established business seeking better performance, 
                our digital marketing agency for small business provides clear priorities,
                 weekly iterations, and transparent reporting that maps directly to your bottom line.
             </p>
            </div>
          </div>
          ...
          <div class="aboutX-actions">
            <a class="btn btn-primary" href="#cases"><i class="fa-solid fa-chart-line"></i> View Case Studies</a>
            <a class="btn btn-ghost" href="#services"><i class="fa-solid fa-grid-2"></i> Explore Services</a>
          </div>
        </div>

        <!-- RIGHT: Animated “media stack” -->
        <div class="aboutX-media reveal" aria-label="About visuals">
          <div class="aboutX-stack" id="aboutTilt">
            <div class="aboutX-card a1">
              <div class="aboutX-cardHead">
                <span class="aboutX-chip"><i class="fa-solid fa-sparkles"></i> Weekly loops</span>
                <span class="aboutX-mini">Ship → learn → improve</span>
              </div>
              <div class="aboutX-spark" aria-hidden="true"></div>
            </div>

            <div class="aboutX-card a2">
              <div class="aboutX-kpi">
                <strong>+41%</strong><span>CVR lift</span>
              </div>
              <div class="aboutX-ring" aria-hidden="true"></div>
            </div>

            <div class="aboutX-photo">
              <img loading="lazy"
                   src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1400&q=80"
                   alt="Team working together" />
              <div class="aboutX-badge">
                <i class="fa-solid fa-bolt" aria-hidden="true"></i>
                <div><strong>Fast execution</strong><span>weekly delivery cadence</span></div>
              </div>
            </div>

            <div class="aboutX-orb" aria-hidden="true"></div>
          </div>
        </div>
      </div>
    </div>
